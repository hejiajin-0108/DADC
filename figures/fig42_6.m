...
text(8.18,-0.915,'$8.32$','Interpreter','latex','FontSize',18);
hold on

plot([8.32 8.32],[0.02 -0.9],'k--','linewidth',2)
hold on

scatter([7 7.05 7.1 7.15 7.2],[0 0 0 0 0],30,'MarkerEdgeColor',[0 .5 .5],'MarkerFaceColor',[0 .7 .7])
hold on 
scatter(7.1:0.05:10.1,s,30,'MarkerEdgeColor',[0 .5 .5],'MarkerFaceColor',[0 .7 .7])
hold on 
