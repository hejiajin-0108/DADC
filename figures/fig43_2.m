...
plot(0:0.02:1,tau_0(1,:),'-','linewidth',3,'color',[255,193,127]/255)
hold on
plot(0:0.02:1,tau_0(2,:),'-','linewidth',3,'color',[86,160,251]/255)
hold on
axis([0 1 0 1.5])
xlabel('$\eta$','Interpreter','latex');
ylabel('$\tau_0$','Interpreter','latex');
legend('Uncontrolled','Controlled','Interpreter','latex','fontsize',14);
