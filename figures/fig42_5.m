...
text(6.53,-0.685,'$6.67$','Interpreter','latex','FontSize',18);
hold on

plot([6.67 6.67],[0.02 -0.7],'k--','linewidth',2)
hold on

scatter([5 5.05 5.1 5.15 5.2],[0 0 0 0 0],30,'MarkerEdgeColor',[0 .5 .5],'MarkerFaceColor',[0 .7 .7])
hold on 
scatter(5.25:0.05:8.25,s,30,'MarkerEdgeColor',[0 .5 .5],'MarkerFaceColor',[0 .7 .7])
hold on 
