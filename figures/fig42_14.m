...
a=2.5;b=1.5;h=1; 
eta=0.95;
d11=0.1;d12=0.1;d21=(n-1)*0.01;d22=0.5;
...
dq=turbo(h);
for n=1:h
    plot(0:0.1:3,tau0(:,n),'-','linewidth',2,'color',dq(n,:));
    hold on;
end
colormap(turbo);
colorbar('FontSize',15,'Direction','reverse','TickLabelInterpreter','latex','TickLabels',{'$\alpha=15$','','','','','$\alpha=1$'})
text(1.12,-2.9,'$\tau_0=0.34$','Interpreter','latex','fontsize',15,'color',[0.4796	0.01583	0.01055]);
