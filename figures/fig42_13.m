...
a=2.5;b=1.5;h=1; 
eta=0.95;
d11=0.1;d12=0;d21=0;d22=(n-1)*0.02;
...
dq=turbo(h);
for n=1:h
    plot(0:0.2:8.2,tau0(:,n),'-','linewidth',2,'color',dq(n,:));
    hold on;
end
colormap(turbo);
colorbar('FontSize',15,'Direction','reverse','TickLabelInterpreter','latex','TickLabels',{'$\alpha=15$','','','','','$\alpha=1$'})
text(3.2,0,'$\tau_0=0.34$','Interpreter','latex','fontsize',15,'color',[0.4796	0.01583	0.01055]);

axis([-0.03 8.22 -0.4 5])
