...
d1111=d11*A*x0;d1122=d12*A*y0;
d2211=d21*A*x0;d2222=d22*A*y0;
  if 1>tau1
        x00=x0;
    else
        x00=zeros(M,1);
...
d1111=d11*A*x1(:,1);d1122=d12*A*y1(:,1);
d2211=d21*A*x1(:,1);d2222=d22*A*y1(:,1);
...
d1111=d11*A*x(:,j);d1122=d12*A*y(:,j);
d2211=d21*A*x(:,j);d2222=d22*A*y(:,j);
...
d1111=d11*A*x1(:,n+1);d1122=d12*A*y1(:,n+1);
d2211=d21*A*x1(:,n+1);d2222=d22*A*y1(:,n+1); 
...
% colorbar('fontsize',13,'ticks',[-0.4 -0.2 0 0.2 0.4]);
% colormap turbo;
% shading interp 
...
zlabel('$v_i$','Interpreter','latex'); % 添加z轴标签
set(gca,'linewidth',2,'fontsize',18,'fontname','Times');
axis([ 0 10 0 100 -0.5 0.5])
shading interp 
grid minor
box on
