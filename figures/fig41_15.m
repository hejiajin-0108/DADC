...
k1=-1+(n-1)*0.1;k2=0.1;k3=-0.2;k4=0.1;
...
a=2.5;b=1.5;h=1; 
d11=0.1;d12=0.1;d21=0.2;d22=0.5;
k1=-0.6;k2=0.1;k3=-1+(n-1)*0.1;k4=0.1;
...
tau_01=(1./w).*acos((cos(eta*pi).*w.^(2*eta)+P1.*cos(eta*pi/2).*w.^(eta)+P2)./(-P3));
tau_0(2,n)=min(tau_01);
end


plot(-1:0.1:0.5,tau_0(1,:),'-','linewidth',3,'color',[239,124,120]/255)
hold on
plot(-1:0.1:0.5,tau_0(2,:),'-','linewidth',3,'color',[118,192,133]/255)
hold on
axis([-1 0 0 1])
xlabel('$k_1(k_3)$','Interpreter','latex');
ylabel('$\tau_0$','Interpreter','latex');
legend('$k_1(k_3=-0.2)$','$k_3(k_1=-0.6)$','Interpreter','latex','fontsize',14);
