clear;
clc;
load A.mat  %%%% Brain network connection matrix

tau=0;
alp=0.9;q1=alp;q2=alp;
rho=7;sigma=5;
d11=0.1;d12=0.1;
...
set(gca,'linewidth',1.5,'fontsize',25,'fontname','Times') 


Range=max(x(:,N+1))-min(x(:,N+1));
StandardDeviation=std(x(:,N+1));
InterquartileRange=iqr(x(:,N+1));
